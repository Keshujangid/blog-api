  ...
  return (
    <>
      <div className="bg-gray-100 min-h-full flex items-center justify-center">
        <div className="relative m-4 w-full max-w-md bg-white px-6 pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 sm:rounded-xl sm:px-10 sm:mx-auto">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="relative mt-6">
                  ...
                  <button
                    ...
                    >
                      <img src={showPassword ? iconShow : iconHide} alt="Toggle visibility" />
                    </button>
